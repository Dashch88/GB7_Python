...
def write_contact(record):
    phonebook = open('Python_HW/Python_HW8/phonebook.txt', 'a')
...
def read_phonebook():
    all_rec = []
    phonebook = open('Python_HW/Python_HW8/phonebook.txt', 'r')
...
def rewrite_phonebook(all_rec):
    phonebook = open('Python_HW/Python_HW8/phonebook.txt', 'w')
